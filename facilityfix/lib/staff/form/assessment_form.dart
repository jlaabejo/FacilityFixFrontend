...
class _AssessmentFormState extends State<AssessmentForm> {
  ...
  void _showSuccessDialog(BuildContext context) {
    final isMaintenance = widget.requestType != null &&
        widget.requestType!.toLowerCase().contains('maintenance');
    ...
    showDialog(
      ...
      builder: (_) => CustomPopup(
        title: 'Success',
        message:
            'Your assessment has been submitted successfully and is now recorded under ${isMaintenance ? 'Maintenance Tasks' : 'Repair Tasks'}.',
        primaryText: isMaintenance ? 'Go to Maintenance Tasks' : 'Go to Repair Tasks',
        onPrimaryPressed: () {
  ...
  Future<void> _submit() async {
    ...
    if (widget.concernSlipId == null || widget.concernSlipId!.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Error: No ID provided'),
          behavior: SnackBarBehavior.floating,
    ...
    try {
      ...
      if (widget.showResolutionType) {
        ...
        endpoint =
            '/job-services/${widget.concernSlipId}/submit-completion-assessment';
      }
  ...
  Widget build(BuildContext context) {
    final subtitle =
        (widget.requestType != null && widget.requestType!.trim().isNotEmpty)
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  widget.showResolutionType
                      ? 'Assessment and Resolution Type'
                      : 'Assessment',
                  style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
