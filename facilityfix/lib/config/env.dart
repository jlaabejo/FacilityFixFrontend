...
class AppEnv {
  ...
  static String? lanIp = '192.168.100.191';

  static const String _WEB_API = 'http://192.168.100.191:8000';
  ...
  static Map<AppRole, String> _deviceHosts(String ip) => {
    AppRole.tenant: 'http://192.168.100.191:8000',
    AppRole.staff: 'http://192.168.100.191:8000',
    AppRole.admin: 'http://192.168.100.191:8000',
  };
