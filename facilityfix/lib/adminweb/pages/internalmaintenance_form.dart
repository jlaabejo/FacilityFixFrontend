                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                _fieldBox(
                                  child: TextFormField(
                                    ...
                                    enabled: false,
                                    decoration: _decoration('System Generated').copyWith(
                                      disabledBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(8),
                                        borderSide: BorderSide(
                                          color: Colors.grey[300]!,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                // Show dialog for custom location
                                showDialog(
                                  context: context,
                                  ...
                                  children: [
                                    ...
                                    _fieldBox(
                                      child: DropdownButtonFormField<String>(
                                        ...
                                        items: ['None', 'Daily', 'Weekly', 'Monthly', 'Quarterly', 'Annually']
                                  ...
                                  children: [
                                    ...
                                    _fieldBox(
                                      child: TextFormField(
                                        ...
                                        decoration: _decoration('e.g., "3 hrs" or "45 mins"'),
                                      ),
                                    ),
                                  ],
                                ),
                                  ...
                                  children: [
                                    ...
                                    _fieldBox(
                                      child: TextFormField(
                                        ...
                                        readOnly: true,
                                        validator: _req,
                                        decoration: _decoration('Select Start Date...').copyWith(
                                    ...
                                    Expanded(
                                      child: _fieldBox(
                                        child: TextFormField(
                                          controller: _assignedStaffController,
                                          validator: _req,
                                          decoration: _decoration('Select or auto-assign staff...'),
                                        ),
                                      ),
                                    ),
                                    const SizedBox(width: 12),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Select a department first, then use Auto-Assign to automatically select the next available staff member using round-robin assignment.',
                      ...
                      _buildSectionHeader(
                        "Notifications",
                        "When to notify admin and staff before the task",
                      ),
                      const SizedBox(height: 24),
