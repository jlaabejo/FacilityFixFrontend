...
class AnnouncementDetailsPage extends StatefulWidget {
  ...
  final Map<String, dynamic>? announcementData; // Optional: pass data from list to avoid re-fetch
...
class _AnnouncementDetailsState extends State<AnnouncementDetailsPage> {
  ...
  void initState() {
    ...
    if (widget.announcementData != null) {
      _announcement = widget.announcementData;
      _isLoading = false;
      print('[TenantAnnouncementDetails] Using provided announcement data for ID: ${widget.announcementId}');
      print('[TenantAnnouncementDetails] Data keys: ${widget.announcementData!.keys.toList()}');
    } else {
      print('[TenantAnnouncementDetails] No data provided, fetching from API for ID: ${widget.announcementId}');
  ...
  Future<void> _fetchAnnouncementDetails() async {
    ...
    try {
      // Try to fetch from API - may fail due to permissions
      ...
      print('[TenantAnnouncementDetails] Error: $e');
    }
  }
