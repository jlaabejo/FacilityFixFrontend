...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadSavedProfile() async {
    ...
    phoneNumberController.text = phone.isNotEmpty ? _formatPhoneNumber(phone) : '';
          ...
          child: Column(
            ...
            children: [
              ProfileInfoWidget(
                ...
                fullName: nameController.text.isNotEmpty ? nameController.text : 'User',
                staffId: _adminId.isNotEmpty ? 'Admin ID: #$_adminId' : 'Admin ID: —',
