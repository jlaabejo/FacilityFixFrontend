...
import 'package:facilityfix/widgets/forgotPassword.dart'; // <-- added
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    super.initState();
    nameController.text = 'John Lester Abejo';
    emailController.text = 'abejojohnlester@example.com';
